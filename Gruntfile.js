...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      dist: {
        files: {
          '<%= lintel.dist %>/navbar.css': 'sass/lintel-core-loader.scss'
        }
      }
    },
    ...
    cssmin: {
      ...
      dist: {
        src: '<%= lintel.dist %>/navbar.css',
        dest: '<%= lintel.dist %>/navbar.min.css'
      }
    },
    ...
    webshot: {
      xs: {
        options: {
          siteType: 'url',
          site: 'http://localhost:4554/navbar.html',
